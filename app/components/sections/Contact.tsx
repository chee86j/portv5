...
export function Contact() {
  return (
    ...
    >
      ...
      <div className="mt-8 flex w-full max-w-3xl flex-col justify-center gap-2 rounded-3xl border border-[rgb(163,163,163)] p-4 transition-colors duration-300 dark:border-[rgb(185,185,185)] dark:bg-[rgb(60,60,60)] sm:flex-row sm:flex-wrap">
        <div className="m-2 flex items-center gap-2 sm:m-4">
          <MdEmail
            size={36}
